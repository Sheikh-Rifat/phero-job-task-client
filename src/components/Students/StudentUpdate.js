...
const StudentUpdate = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://glacial-savannah-90083.herokuapp.com/single-student?studentId=${studentId}`
      )
      .then((response) => {
  ...
  const handleForm = (e) => {
    ...
    axios
      .patch(
        `https://glacial-savannah-90083.herokuapp.com/update-student-info?studentId=${studentId}`,
        studentData
      )
      .then((response) => {
    ...
    <section id="update-student-page">
      <div className="update-student-page-container">
        <div className="update-student-page-title">
          <h1 className="border-bottom border-dark">Update Student Info</h1>
        </div>
